# 1 "c:\\perf\\pt_app_list\\wmx\\wmx_alldcs\\g4\\blankscript\\\\combined_Blankscript.c"
...
# 1 "c:\\perf\\pt_app_list\\wmx\\wmx_alldcs\\g4\\blankscript\\\\combined_Blankscript.c" 2
...
# 2 "c:\\perf\\pt_app_list\\wmx\\wmx_alldcs\\g4\\blankscript\\\\combined_Blankscript.c" 2
...
# 3 "c:\\perf\\pt_app_list\\wmx\\wmx_alldcs\\g4\\blankscript\\\\combined_Blankscript.c" 2
...
vuser_init()
{
	...
	char string[256];
	char OutputMsg[256];	 
	char		OutputDir[64] = "D:\\WMX\\";
	char		OutputFile[64];
	lr_save_datetime("%c", 0, "timenow");
	lr_save_datetime("%Y%b%d", 0, "date_today");

 
	lr_save_string("20","var_think_time");
	pvci=lrvtc_connect("10.238.85.94",8938,0x01);
	
	web_set_sockets_option("SSL_VERSION", "AUTO"); 
   
    lr_save_string("https", "var_protocal");
	...
	web_add_cookie("currentLoginPage=Web; DOMAIN=qa.wmxbolt.wescodist.com");
	web_reg_save_param_ex(
		"ParamName=C_FlowIDLogin",
		"LB/IC=name=\"flowId\" value=\"",
		"RB/IC=\" />",
		"SEARCH_FILTERS",
		"Scope=Body",
		"LAST");
	...
	web_reg_save_param_ex(
		...
		"LB/IC=id=\"javax.faces.ViewState\" value=\"",
		"RB/IC=\" />",
		"SEARCH_FILTERS",
		"Scope=Body",
		"LAST");
	...
	lrvtc_query_column("URL", 1);
	lrvtc_retrieve_messages1("userid;password;dc", ";");
...
# 89 "vuser_init.c"
	...
	web_url("wmx", 
		...
		"Mode=HTML", 
		"EXTRARES", 
		"Url=image/min.gif", "ENDITEM", 
		"Url=image/close.gif", "ENDITEM", 
		"LAST");

lr_end_transaction("T01_Homepage", 2);
	...
	lr_think_time(atoi(lr_eval_string("{var_think_time}")));
	...
	lr_start_transaction("T02_Login");

	 
# 199 "vuser_init.c"
	
	web_submit_data("login.faces", 
		"Action={URL}/login.faces", 
		"Method=POST", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=AJAXREQUEST", "Value=j_id_jsp_1983690674_0", "ENDITEM", 
		"Name=body_tile:login:username", "Value={userid}", "ENDITEM", 
		"Name=body_tile:login:password", "Value=", "ENDITEM", 
		"Name=body_tile:login:dcCodeList", "Value=", "ENDITEM", 
		"Name=flowId", "Value={C_FlowIDLogin}", "ENDITEM", 
		"Name=_transactionId", "Value={C_FlowIDLogin}", "ENDITEM", 
		"Name=body_tile:login_SUBMIT", "Value=1", "ENDITEM", 
		"Name=javax.faces.ViewState", "Value={C_ViewState}", "ENDITEM", 
		"Name=body_tile:login:loginAjaxCall", "Value=body_tile:login:loginAjaxCall", "ENDITEM", 
		"LAST");

	web_add_cookie("security.client.type=Web; DOMAIN=qa.wmxbolt.wescodist.com");
	
		web_reg_find("Text=Welcome", 
		"LAST");

	web_submit_data("login.faces_2", 
		"Action={URL}/login.faces", 
		"Method=POST", 
		"RecContentType=text/html", 
		"Referer={URL}/", 
		...
		"ITEMDATA", 
		"Name=body_tile:login:username", "Value={userid}", "ENDITEM", 
		"Name=body_tile:login:password", "Value={password}", "ENDITEM", 
		"Name=body_tile:login:dcCodeList", "Value={dc}", "ENDITEM", 
		"Name=body_tile:login:submitBtn", "Value=Login", "ENDITEM", 
		"Name=flowId", "Value={C_FlowIDLogin}", "ENDITEM", 
		"Name=_transactionId", "Value={C_FlowIDLogin}", "ENDITEM", 
		"Name=body_tile:login_SUBMIT", "Value=1", "ENDITEM", 
		"Name=javax.faces.ViewState", "Value={C_ViewState1}", "ENDITEM", 
		"EXTRARES", 
		"Url=javascript/jscookmenu/Click/arrow.gif", "Referer={URL}/welcome.faces", "ENDITEM", 
		"LAST");
	...
	lr_end_transaction("T02_Login",2);


		sprintf(OutputMsg,"%s \t%s \t%s%s \t%s%s",lr_eval_string("{timenow}"),"Function_Name : Allocation_Fail", "App Server is : ", lr_eval_string("{Server_Name}"), "VuserID is : ", lr_eval_string(""));
		sprintf(OutputFile,"%s\\%s.txt ",OutputDir,lr_eval_string("{date_today}"));
...
# 4 "c:\\perf\\pt_app_list\\wmx\\wmx_alldcs\\g4\\blankscript\\\\combined_Blankscript.c" 2
...
# 5 "c:\\perf\\pt_app_list\\wmx\\wmx_alldcs\\g4\\blankscript\\\\combined_Blankscript.c" 2
...
# 6 "c:\\perf\\pt_app_list\\wmx\\wmx_alldcs\\g4\\blankscript\\\\combined_Blankscript.c" 2
